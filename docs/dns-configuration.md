...
> **Note:** If you’re unable to add or modify domains in the Altis Dashboard settings panel, it’s likely that self-service domain management is disabled for your environment. In this case, please [contact Altis support](support://new) to request domain changes or enable this feature.
